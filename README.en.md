...
# Skill Seekers (SanHsien Maintenance Fork)

This repository is a Windows-first maintenance fork of [yusufkaraaslan/Skill_Seekers](https://github.com/yusufkaraaslan/Skill_Seekers), licensed under the MIT License. See [README.md](README.md) for the Traditional Chinese guide and [FORK.md](FORK.md) for maintenance differences.
